...
def read_options():
    ...
    parser.add_argument("--dataset", default="NELL", type=str,help= 'WiKi or NELL')
    ...
    parser.add_argument('--latent_dim_size', type=float, default=2, help='dimention of feature encoder latent dim resize e.g NELL = 2')
