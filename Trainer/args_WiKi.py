...
def read_options_WiKi():
    parser = argparse.ArgumentParser()
    parser.add_argument("--dataset", default="WiKi", type=str,help= 'WiKi or NELL')
    parser.add_argument("--embed_model", default='DistMult', type=str)
    parser.add_argument("--prefix", default='intial', type=str)

    # embedding dimension
    parser.add_argument("--embed_dim", default=50, type=int, help='dimension of triple embedding')
    parser.add_argument('-w_dim', type=int, default=50, help='dimension of word embedding [50, 300]')
    parser.add_argument("--ep_dim", default=800, type=int, help='dimension of entity pair embedding')
    parser.add_argument('--sp_dim1', default=100, type=int)
    parser.add_argument('--sp_dim2', default=100, type=int)
    ...
    parser.add_argument("--add_loss_weight", default=0.01, type=float, help='NELL loss')
    ...
    # training times
    parser.add_argument("--train_times", default=7500, type=int)
    ...
    args.save_path = "../../new_models/intial"
...
if __name__ == "__main__":
    read_options_WiKi()    # initial equals read_options()
